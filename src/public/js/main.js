$("#document").ready(function () {
	...
	var vung = new ol.layer.Image({
        source: new ol.source.ImageWMS({
          ratio: 1,
          url: "http://localhost:8080/geoserver/DoBaToan/wms", //cần thay url
          params: {
            FORMAT: format,
            VERSION: "1.1.0",
            STYLES: "",
            LAYERS: "DoBaToan:dan_cu", //cần thay
          },
        }),
      });
      ...
      var duong = new ol.layer.Image({
        source: new ol.source.ImageWMS({
          ratio: 1,
          url: "http://localhost:8080/geoserver/DoBaToan/wms", //cần thay
          params: {
            FORMAT: format,
            VERSION: "1.1.0",
            STYLES: "",
            LAYERS: "DoBaToan:giao_thong", //cần thay
          },
        }),
      });
      ...
      var diem = new ol.layer.Image({
        source: new ol.source.ImageWMS({
          ...
          params: {
            ...
            VERSION: "1.1.0",
            STYLES: "",
            LAYERS: "DoBaToan:co_so_ha_tang", //cần thay
          },
        }),
      });
